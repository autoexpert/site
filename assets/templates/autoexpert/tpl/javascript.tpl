...
<!-- javascript-->
<script><?php echo getFileContent('assets/templates/autoexpert/js/yepnope.js');?></script>
<script><?php echo getFileContent('assets/templates/autoexpert/js/modernizr.js');?></script>
<!-- end javascript-->
<!-- home javascript-->
<script>
	<!--include ../js/home.js-->		
